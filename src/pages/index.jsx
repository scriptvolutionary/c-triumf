                        ...
                        <div className='flex flex-col lg:gap-16 xs:gap-8'>
                            <div className='w-full flex xs:flex-col items-center justify-between xs:gap-8 gap-16'>
                                ...
                                <p className='lg:text-lg font-medium text-neutral/75 xs:text-center'>
                                    Качественное исследование на полиграфе окупается в десятки раз,
                                    именно поэтому наши Партнеры–Заказчики возвращаются к нам и
                        ...
                        <div className='flex flex-col lg:gap-16 xs:gap-8'>
                            <div className='w-full flex flex-col items-center justify-between xs:gap-8 gap-16'>
                                ...
                                <p className='lg:text-lg font-medium text-neutral/75 lg:w-5/6 text-center'>
                                    Ключевое. За все проверки экспертов есть ответственное лицо-
                                    основатель Триумфа Татьяна Алфеева. В случае вопросов есть
                                    христинская позиция быть на стороне Истины, а не полиграфолога
                                    или заказчика.
                                </p>
                            </div>
...
Home.pageDescription =
    'Полиграфолог для физ. и юр.лиц проверка на детекторе лжи при расследованиях, при приеме на работу, а также по адвокатскому запросу.'
