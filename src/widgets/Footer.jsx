    ...
    return (
        <footer className='glass w-screen h-full'>
            <div className='max-w-7xl mx-auto px-4'>
                <div className='footer lg:py-12 xs:py-6'>
                    {FooterLinks.map((l) => (
                        <div key={l.id}>
                            <span className='footer-title lg:text-lg'>{l.title}</span>
                            {l.content.map((c) => (
                                <Link href={c.path} key={c.id}>
                                    <a className='w-full lg:text-base font-medium xs:active:text-secondary lg:hover:text-secondary lg:hover:translate-x-1 lg:hover:-translate-y-1 ease-in-out transition-all transform-gpu'>
                                        {c.title}
                                    </a>
                                </Link>
                            ))}
                    ...
                    <div>
                        <span className='footer-title lg:text-lg'>Обратная связь</span>
                        <Link href='/contacts'>
                            <a className='w-full lg:text-base font-medium xs:active:text-secondary lg:hover:text-secondary lg:hover:translate-x-1 lg:hover:-translate-y-1 ease-in-out transition-all transform-gpu'>
                                Контакты
                            </a>
            ...
            <div className='border-t border-base-300'>
                <div className='max-w-7xl mx-auto px-4'>
                    <div className='footer lg:py-6 xs:py-3 lg:text-base'>
