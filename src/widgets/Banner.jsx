		...
		<>
			{TriumfDomen.pathname !== ('' || '/') ? (
				<section className='w-full h-full'>
					<figure className='fixed -top-44 left-0 w-screen h-full -z-10'>
				...
				<section className='w-screen h-full'>
					<div className='card  lg:h-[720px] w-full image-full rounded-none -z-10'>
						<figure>
							<video
								className='xs:hidden absolute w-full'
								autoPlay
								loop
							>
								<source
						...
						<div className='card-body max-w-7xl mx-auto px-4'>
							<div className='w-full h-full flex flex-col justify-center'>
								<div className='w-full xs:text-justify flex flex-col gap-8'>
									<h2 className='text-neutral text-4xl xs:text-2xl font-bold'>
										Полиграфолог. Проверка на полиграфе в
										Москве.
									</h2>
									<p className='text-lg xs:text-sm text-neutral/75 text-justify font-semibold'>
