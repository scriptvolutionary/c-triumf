...
export const Header = () => {
    ...
    useEffect(() => {
        ...
        const add_shadow_on_scroll = () => {
            header.classList.add('xs:bg-base-100', 'lg:glass-default', 'shadow-xl')
        }
        const remove_shadow_on_scroll = () => {
            header.classList.remove('xs:bg-base-100', 'lg:glass-default', 'shadow-xl')
        }

        window.addEventListener('scroll', function () {
            scrollpos = window.scrollY

            scrollpos >= scrollChange ? add_shadow_on_scroll() : remove_shadow_on_scroll()
        })
    }, [])
